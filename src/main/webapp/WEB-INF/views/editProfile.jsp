        ...
        <div class="help--slides active" data-id="1">
          ...
          <div   style="border-bottom: 4px solid black;">
            <section class="login-page">
              <form:form method="post" modelAttribute="userlogged">
              ...
              <div class="form-group">
                ...
                <form:input itemValue="id" itemLabel="name" path="username" items="${userlogged}"/>
                Nazwa użytkownika
              </div>

              <div class="form-group">

                <form:input itemValue="id" itemLabel="email" path="email" items="${userlogged}"/>
                Email
              </div>
